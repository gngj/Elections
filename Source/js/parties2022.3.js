var getParties = function () {
  ...
  var betenu = new party('ישראל ביתנו', 246712);
  var tziyonutdatit = new party('הציונות הדתית', 506760);
  var meshutefet = new party('חד"ש תע"ל', 141814);
  var meretz = new party('מרצ', 199998);
  var aravitmeuhedet = new party('ערבית מאוחדת', 176223);
